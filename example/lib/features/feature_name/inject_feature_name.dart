...
final featureNameRemoteDataSourceProvider = Provider<FeatureNameRemoteDataSource>(
  (ref) => FeatureNameRemoteDataSourceImpl(),
);

final featureNameRepositoryProvider = Provider<FeatureNameRepository>(
  (ref) => FeatureNameRepositoryImpl(remoteDataSource: ref.watch(featureNameRemoteDataSourceProvider)),
);
